...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj8976 = {};return obj8976;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3522__auto__ = this$;if(and__3522__auto__)
...
{var x__4161__auto__ = (((this$ == null))?null:this$);return (function (){var or__3534__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4161__auto__)]);if(or__3534__auto__)
{return or__3534__auto__;
} else
{var or__3534__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3534__auto____$1)
...
return (function (p__8977){var vec__8978 = p__8977;var k = cljs.core.nth.call(null,vec__8978,(0),null);var v = cljs.core.nth.call(null,vec__8978,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__8979){var vec__8980 = p__8979;var k = cljs.core.nth.call(null,vec__8980,(0),null);var v = cljs.core.nth.call(null,vec__8980,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
